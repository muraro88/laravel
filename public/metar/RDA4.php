...
function pista($pis,$pis2){
 ...
 $corsn = fechado($metarsn);
 $corsl = fechado($metarsl);
 $cormq = fechado($metarmq);
 $corrb = fechado($metarrb);
 $corat = fechado($metarat);
 $cortf = fechado($metartf);
 $corcc = fechado($metarcc);
 $corcy = fechado($metarcy);
 $coreg = fechado($metareg);
 $corcz = fechado($metarcz);
 $corua = fechado($metarua);
 $cortt = fechado($metartt);
// $rwy = pista($metarG);
 $horaUTC = $hora+3;
...
<tr><td align="center">
   <h1>RDA4 - Cor Meteorol&oacute;gica</h1>
</table>
<?php echo $teste; ?>
<!--
...
<tr><td>
<div id="<?php echo $corsn; ?>"><?php echo $metarsn; ?></div>
</td></tr>
<tr><td>
<div id="<?php echo $corsl; ?>"><?php echo $metarsl; ?></div>
</td></tr>
<tr><td>
<div id="<?php echo $cormq; ?>"><?php echo $metarmq; ?></div>
</td></tr>
<tr><td>
<div id="<?php echo $corrb; ?>"><?php echo $metarrb; ?></div>
</td></tr>
<tr><td>
<div id="<?php echo $corat; ?>"><?php echo $metarat; ?></div>
</td></tr>
<tr><td>
<div id="<?php echo $cortf; ?>"><?php echo $metartf; ?></div>
</td></tr>
<tr><td>
<div id="<?php echo $corcc; ?>"><?php echo $metarcc; ?></div>
</td></tr>
<tr><td>
<div id="<?php echo $corcy; ?>"><?php echo $metarcy; ?></div>
</td></tr>
<tr><td>
<div id="<?php echo $coreg; ?>"><?php echo $metareg; ?></div>
</td></tr>
<tr><td>
<div id="<?php echo $corcz; ?>"><?php echo $metarcz; ?></div>
</td></tr>
<tr><td>
<div id="<?php echo $corua; ?>"><?php echo $metarua; ?></div>
</td></tr>
<tr><td>
<div id="<?php echo $cortt; ?>"><?php echo $metartt; ?></div>
</td></tr>
</table>
