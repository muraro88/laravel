...
function pista($pis,$pis2){
 ...
 $corbr = fechado($metarBR);
 $coran = fechado($metarAN);
 $corgo = fechado($metarGO);
 $corvt = fechado($metarVT);
 $corad = fechado($metarAD);
 $corbh = fechado($metarBH);
 $corcf = fechado($metarCF);
 $corpj = fechado($metarPJ);
 $corys = fechado($metarYS);
// $rwy = pista($metarG);
 $horaUTC = $hora+3;
...
<tr><td>
<div id="<?php echo $corbr; ?>"><?php echo $metarbr; ?></div>
</td></tr>
<tr><td>
<div id="<?php echo $coran; ?>"><?php echo $metaran; ?></div>
</td></tr>
<tr><td>
<div id="<?php echo $corgo; ?>"><?php echo $metargo; ?></div>
</td></tr>
<tr><td>
<div id="<?php echo $corvt; ?>"><?php echo $metarvt; ?></div>
</td></tr>
<tr><td>
<div id="<?php echo $corad; ?>"><?php echo $metarad; ?></div>
</td></tr>
<tr><td>
<div id="<?php echo $corbh; ?>"><?php echo $metarbh; ?></div>
</td></tr>
<tr><td>
<div id="<?php echo $corcf; ?>"><?php echo $metarcf; ?></div>
</td></tr>
<tr><td>
<div id="<?php echo $corys; ?>"><?php echo $metarys; ?></div>
</td></tr>
</table>
...
<form action="METAR COR DO CAMPO TESTE.php" target="_blank" id="METAR COR DO CAMPO TESTE" method="post">
<input id="metar" type="submit" value="METAR COR DO CAMPO TESTE" />
</form>
</form>
...
<input id="rotaer" type="submit" value="AISWEB (IND OACI BR):" />
