...
function pista($pis,$pis2){
 ...
 $corfz = fechado($metarfz);
 $cornt = fechado($metarnt);
 $corsg = fechado($metarsg);
 $corrf = fechado($metarrf);
 $cormo = fechado($metarmo);
 $corar = fechado($metarar);
 $corps = fechado($metarps);
 $corpf = fechado($metarpf);
 $corpl = fechado($metarpl);
 $corjp = fechado($metarjp);
// $rwy = pista($metarG);
 $horaUTC = $hora+3;
...
<tr><td align="center">
   <h1>RDA3 - Cor Meteorol&oacute;gica</h1>
...
<table>
<tr><td>
<div id="<?php echo $corfz; ?>"><?php echo $metarfz; ?></div>
</td></tr>
<tr><td>
<div id="<?php echo $cornt; ?>"><?php echo $metarnt; ?></div>
</td></tr>
<tr><td>
<div id="<?php echo $corsg; ?>"><?php echo $metarsg; ?></div>
</td></tr>
<tr><td>
<div id="<?php echo $corrf; ?>"><?php echo $metarrf; ?></div>
</td></tr>
<tr><td>
<div id="<?php echo $cormo; ?>"><?php echo $metarmo; ?></div>
</td></tr>
<tr><td>
<div id="<?php echo $corar; ?>"><?php echo $metarar; ?></div>
</td></tr>
<tr><td>
<div id="<?php echo $corps; ?>"><?php echo $metarps; ?></div>
</td></tr>
<tr><td>
<div id="<?php echo $corpf; ?>"><?php echo $metarpf; ?></div>
</td></tr>
<tr><td>
<div id="<?php echo $corpl; ?>"><?php echo $metarpl; ?></div>
</td></tr>
<tr><td>
<div id="<?php echo $corjp; ?>"><?php echo $metarjp; ?></div>
</table>
...
<form action="http://www.aisweb.intraer/?i=publicacoes" target="_blank" id="cartas" method="post">
<input id="cartas" type="submit" value="AISWEB-Publicações" />
</form>
</form>
<form action="http://www.redemet.intraer/?i=produtos&p=consulta-de-mensagens-opmet#" target="_blank" id="metar" method="post">
...
<form action="http://www.aisweb.intraer/?i=aerodromos" target="_blank" id="rotaer" method="get">
...
<form action="http://www.aisweb.intraer/notam/rs.cfm#" target="_blank" id="notam" method="post">
<input id="enviar" type="submit" value="NOTAM:" />
<input type="text" name="codigo" maxlength="4" onBlur="this.value=this.value.toUpperCase()" style='text-transform: uppercase;' size="2" />
...
<form action="https://www.google.com/maps/d/embed" target="_blank" method="get">
<input type="submit" value="FIR RF Setores" />
<input type="hidden" name="mid" value="10J1HV_ZLqECXCKBmye4N2HBQnUw" />
<input type="hidden" name="hl" value="pt-BR" />
</form>
</td><td>
   <h1>Cartas PAR</h1>
   <ul>
   <li><a href="cartas/CARTA 01 PAR RWY16L.jpg" target="_blank">CARTA 01 PAR RWY16L</a> </li>
   <li><a href="cartas/CARTA 02 VOR PAR 16L.jpg" target="_blank">CARTA 02 VOR PAR 16L</a> </li>
   <li><a href="cartas/CARTA 03 PAR ARCO DME 16L.jpg" target="_blank">CARTA 03 PAR ARCO DME 16L</a> </li>
   <li><a href="cartas/CARTA 04 PAR ARCO DME 34R.jpg" target="_blank">CARTA 04 PAR ARCO DME 34R</a> </li>
   <li><a href="cartas/CARTA 05 PAR RWY 12.jpg" target="_blank">CARTA 05 PAR RWY 12</a> </li>
   <li><a href="cartas/CARTA 06  PAR ARCO DME RWY 12.jpg" target="_blank">CARTA 06  PAR ARCO DME RWY 12</a> </li>
   </td><td>
   <h1>Documentos</h1>
   <ul>
<!--
    <li><a href="docs/CAOp 60-1 v3.0.pdf" target="docs">CAOp 60-1 v3.0</a> </li>
	<li><a href="docs/CAOp-10-19-APP-SBXT-e-TWR-SBSG.pdf" target="docs">CAOp-10-19-APP-SBXT-e-TWR-SBSG</a> </li>
-->
	</ul>
</table>
</BODY>
